...
def sample_image_bytes():
    """Return valid JPEG image bytes for testing."""
    # Minimal valid JPEG
    return (
        ...
        b"\x00\x08\x01\x01\x00\x00?\x00\xfb\xd5\xff\xd9"
    )


@pytest.fixture
def sample_png_bytes():
    """Return valid PNG image bytes for testing."""
...
def sample_predictions():
    """Return sample YOLO predictions for testing."""
    return [
        ("cloud", 0.85),
        ("sunset", 0.72),
        ("bird", 0.45),
